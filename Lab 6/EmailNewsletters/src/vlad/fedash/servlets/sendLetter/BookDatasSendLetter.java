...
@WebServlet("/BookDatasSendLetter")
public class BookDatasSendLetter extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String fileName = "BookDatasList.xml";
			String filePath = "D:\\Education\\3 Course\\2 Semestr\\Java EE\\Lab 6\\EmailNewsletters\\WebContent\\XMLFiles\\BookDatasList.xml";
